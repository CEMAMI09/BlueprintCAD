...
import { getUserFromRequest, verifyAuth } from '../../../shared/utils/auth.js';
import { filterProjectsByPrivacy } from '../../../shared/utils/privacy-utils.js';
...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      try {
        const { extractFileMetadata } = require('../../../shared/utils/file-metadata-utils.js');
      ...
      if (folder_id) {
        try {
          const { hasFeature } = require('../../../shared/utils/subscription-utils.js');
        ...
        try {
          if (fs.existsSync(fullFilePath)) {
            ...
            try {
              ...
              const { generateThumbnail } = require('../../../shared/utils/generateThumbnail.js');
