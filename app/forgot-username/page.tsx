  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.error || 'Failed to send username reminder');
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Forgot Username?</h2>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    Check your inbox and spam folder for your username.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center text-xs text-gray-500">
          <p>
            For security reasons, we don't reveal if an email address is registered.
          </p>
        </div>
      </div>
    </div>
