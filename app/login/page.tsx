          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-8">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full px-4 py-3 bg-white hover:bg-gray-100 text-gray-900 rounded-lg font-medium transition flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {oauthLoading === 'google' ? (
              ...
              <button
                ...
                disabled={oauthLoading !== null}
                className="w-full px-4 py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-lg font-medium transition flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {oauthLoading === 'github' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm flex flex-col items-end gap-1">
                  ...
                  <Link href="/forgot-username" className="text-gray-400 hover:text-gray-300 text-xs">
                    Forgot username?
                  </Link>
                </div>
              </div>
